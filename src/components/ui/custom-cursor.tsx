...
export function CustomCursor() {
  ...
  useGSAP(() => {
    ...
    const handleHoverLeave = () => {
      gsap.to(cursorRef.current, { scale: 1, backgroundColor: "transparent", border: "1px solid white", duration: 0.3 });
    };
  ...
  return (
    <div
      ref={cursorRef}
      className="pointer-events-none fixed top-0 left-0 z-[9999] h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white bg-transparent mix-blend-difference"
